  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Sportsmap, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Sportsmap.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sportsmap, accessible from
            <a
              href="https://sportsmap.philippkraus.me"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://sportsmap.philippkraus.me
            </a>
          </p>
        </li>
        <li>
      ...
      <h4>Usage Data</h4>
      <p>
        Usage Data is collected once using the "Save Data" functionality of the
        Service.
      </p>
      <p>
      ...
      <p>We DO NOT use Cookies and similar tracking technologies</p>
      ...
      <p>
        ...
        in to Your Strava Account, and visiting the account settings section
      ...
      <ul>
        <li>
          ...
          <a
            href="https://philippkraus.me/"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://philippkraus.me/
          </a>
        </li>
      </ul>
    </div>
